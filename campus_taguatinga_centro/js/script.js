...
/*Mapa do Leaflet*/
var mymap = L.map("mapid").setView([-15.794215, -48.101877], 10 );
...
samambaia.bindPopup("Campus Samambaia<br><a onclick=\"myNavFunc(-15.891461, -47.780270)\">Ir para este campus!</a>");
...
taguaCentro.bindPopup("<b>Você está aqui!!!</b><br>Campus Taguatinga Centro<br>").openPopup();
