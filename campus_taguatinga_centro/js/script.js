...
//function initmap() {
	...
	map.setView(new L.LatLng(-15.840987, -48.046987), 10 );
  map.addLayer(osm);
  
  var reitoria =new L.marker([-15.7539882,-47.8794432]).addTo(map);
  reitoria.bindPopup("Reitoria<br><a onclick=\"myNavFunc(-15.7539882,-47.8794432)\">Ir para este campus!</a>");
  ...
  taguaCentro.bindPopup("<b>Você está aqui!!!</b><br>IFB - Campus Taguatinga Centro").openPopup();
